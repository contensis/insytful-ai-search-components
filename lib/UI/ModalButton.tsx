...
export function ModalButton({ toggle, isOpen }: ModalButtonProps) {
  return (
    <button
      ...
      onClick={toggle}
      className="ai-lib-trigger flex items-center gap-0.25rem py-[1rem] px-[0.75rem] bg-[var(--ai-lib-btn-header-search-bg-default)] hover:bg-[var(--ai-lib-btn-header-search-bg-hover)] absolute inset-0" 
    >
      ...
      {!isOpen ? (
        ...
        >
          <path
            fill="var(--ai-lib-btn-header-search-text)"
