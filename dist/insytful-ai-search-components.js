import p, { createContext as ze, useState as Y, useRef as D, useEffect as q, useCallback as Se, useMemo as J, useContext as ge, forwardRef as We } from "react";
...
var $t = { AsyncMode: Ae, ConcurrentMode: be, ContextConsumer: de, ContextProvider: ue, Element: Pe, ForwardRef: fe, Fragment: se, Lazy: he, Memo: me, Portal: Fe, Profiler: ce, StrictMode: le, Suspense: pe, isAsyncMode: function(t) {
  ...
  process.env.NODE_ENV !== "production" && (function() {
    ...
    var N = s, O = g, j = m, L = d, G = n, H = C, B = i, S = A, l = F, c = o, h = f, x = a, y = b, E = !1;
    function v(u) {
      return w(u) === g;
    }
    e.AsyncMode = N, e.ConcurrentMode = O, e.ContextConsumer = j, e.ContextProvider = L, e.Element = G, e.ForwardRef = H, e.Fragment = B, e.Lazy = S, e.Memo = l, e.Portal = c, e.Profiler = h, e.StrictMode = x, e.Suspense = y, e.isAsyncMode = function(u) {
...
var _t = function(t, e, r) {
  var n = Y([]), o = n[0], i = n[1], a = Y(!1), f = a[0], d = a[1], m = Y(null), s = m[0], g = m[1], C = Se(function(b, T) {
    return jt(void 0, void 0, void 0, function() {
      var F, A, I, M, z, R, w, N, O, j, L, G, H, B, S, l, c, h, x, y, E, v;
      return Lt(this, function(u) {
        switch (u.label) {
          ...
          case 13:
            ...
            j = w.body.getReader(), L = new TextDecoder("utf-8"), G = "", H = "", i(function(k) {
          ...
          case 15:
            ...
            for (G += L.decode(S, { stream: !0 }), l = G.split(`
...
`),
  ...
  return /* @__PURE__ */ p.createElement(
    ...
    i ? /* @__PURE__ */ p.createElement(
      ...
      t.content
    ) : n ? /* @__PURE__ */ p.createElement(Er, { searchingText: o }) : /* @__PURE__ */ p.createElement(
      "div",
      {
        style: { overflowWrap: "anywhere", wordBreak: "break-word" },
      ...
      a.slice(1).map((f, d) => /* @__PURE__ */ p.createElement(
        "div",
        {
          key: `${d}-${Le(f)}`,
...
function wt({
  ...
  const { mode: o } = je("Search.Mode"), { onOpenChange: i } = W("Search.Mode"), a = o === e, f = !!r, d = Se(
    async (m) => {
      if (!r) return;
