import f, { createContext as Ue, useState as H, useRef as Y, useEffect as V, useCallback as oe, useMemo as We, useContext as Ye, forwardRef as ct } from "react";
...
var Te = function() {
  ...
  var e = t.render, r = t.onLoadCallbackName, n = t.language, o = t.onLoad, i = t.useRecaptchaNet, a = t.useEnterprise, u = t.scriptProps, p = u === void 0 ? {} : u, h = p.nonce, d = h === void 0 ? "" : h, b = p.defer, I = b !== void 0 && b, N = p.async, R = N !== void 0 && N, P = p.id, w = P === void 0 ? "" : P, T = p.appendTo, F = w || "google-recaptcha-v3";
  if ((function(E) {
    ...
    A.id = F, A.src = $ + "?render=" + e + (e === "explicit" ? "&onload=" + r : "") + (n ? "&hl=" + n : ""), d && (A.nonce = d), A.defer = !!I, A.async = !!R, A.onload = o, (T === "body" ? document.body : document.getElementsByTagName("head")[0]).appendChild(A);
  }
}, ze = function(t) {
...
Oe.Consumer;
function pt(t) {
  var e = t.reCaptchaKey, r = t.useEnterprise, n = r !== void 0 && r, o = t.useRecaptchaNet, i = o !== void 0 && o, a = t.scriptProps, u = t.language, p = t.container, h = t.children, d = H(null), b = d[0], I = d[1], N = Y(e), R = JSON.stringify(a), P = JSON.stringify(p?.parameters);
  V((function() {
    if (e) {
      var F = a?.id || "google-recaptcha-v3", $ = a?.onLoadCallbackName || "onRecaptchaLoadCallback";
      return window[$] = function() {
        var A = n ? window.grecaptcha.enterprise : window.grecaptcha, E = Te({ badge: "inline", size: "invisible", sitekey: e }, p?.parameters || {});
        N.current = A.render(p?.element, E);
      }, ft({ render: p?.element ? "explicit" : e, onLoadCallbackName: $, useEnterprise: n, useRecaptchaNet: i, scriptProps: a, language: u, onLoad: function() {
  ...
  }), [n, i, R, P, u, e, p?.element]);
  var w = oe((function(F) {
    if (!b || !b.execute) throw new Error("<GoogleReCaptchaProvider /> Google Recaptcha has not been loaded");
    return b.execute(N.current, { action: F });
  }), [b, N]), T = We((function() {
    return { executeRecaptcha: b ? w : void 0, container: p?.element };
  }), [w, b, p?.element]);
  return f.createElement(Oe.Provider, { value: T }, h);
}
var mt = function() {
  return Ye(Oe);
};
...
var wt = { AsyncMode: Ie, ConcurrentMode: ve, ContextConsumer: fe, ContextProvider: de, Element: Re, ForwardRef: pe, Fragment: le, Lazy: be, Memo: he, Portal: Pe, Profiler: ue, StrictMode: ce, Suspense: me, isAsyncMode: function(t) {
  return je(t) || B(t) === Ie;
...
}, typeOf: B }, C = Xe((function(t, e) {
  process.env.NODE_ENV !== "production" && (function() {
    var r = typeof Symbol == "function" && Symbol.for, n = r ? /* @__PURE__ */ Symbol.for("react.element") : 60103, o = r ? /* @__PURE__ */ Symbol.for("react.portal") : 60106, i = r ? /* @__PURE__ */ Symbol.for("react.fragment") : 60107, a = r ? /* @__PURE__ */ Symbol.for("react.strict_mode") : 60108, u = r ? /* @__PURE__ */ Symbol.for("react.profiler") : 60114, p = r ? /* @__PURE__ */ Symbol.for("react.provider") : 60109, h = r ? /* @__PURE__ */ Symbol.for("react.context") : 60110, d = r ? /* @__PURE__ */ Symbol.for("react.async_mode") : 60111, b = r ? /* @__PURE__ */ Symbol.for("react.concurrent_mode") : 60111, I = r ? /* @__PURE__ */ Symbol.for("react.forward_ref") : 60112, N = r ? /* @__PURE__ */ Symbol.for("react.suspense") : 60113, R = r ? /* @__PURE__ */ Symbol.for("react.suspense_list") : 60120, P = r ? /* @__PURE__ */ Symbol.for("react.memo") : 60115, w = r ? /* @__PURE__ */ Symbol.for("react.lazy") : 60116, T = r ? /* @__PURE__ */ Symbol.for("react.block") : 60121, F = r ? /* @__PURE__ */ Symbol.for("react.fundamental") : 60117, $ = r ? /* @__PURE__ */ Symbol.for("react.responder") : 60118, A = r ? /* @__PURE__ */ Symbol.for("react.scope") : 60119;
    function E(c) {
    ...
    var j = d, K = b, U = h, M = p, W = n, q = I, z = i, S = w, s = P, l = o, m = u, v = a, g = N, k = !1;
    function y(c) {
      return E(c) === b;
    }
    e.AsyncMode = j, e.ConcurrentMode = K, e.ContextConsumer = U, e.ContextProvider = M, e.Element = W, e.ForwardRef = q, e.Fragment = z, e.Lazy = S, e.Memo = s, e.Portal = l, e.Profiler = m, e.StrictMode = v, e.Suspense = g, e.isAsyncMode = function(c) {
      return k || (k = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), y(c) || E(c) === d;
    }, e.isConcurrentMode = y, e.isContextConsumer = function(c) {
      return E(c) === h;
      ...
      return typeof c == "string" || typeof c == "function" || c === i || c === b || c === u || c === a || c === N || c === R || typeof c == "object" && c !== null && (c.$$typeof === w || c.$$typeof === P || c.$$typeof === p || c.$$typeof === h || c.$$typeof === I || c.$$typeof === F || c.$$typeof === $ || c.$$typeof === A || c.$$typeof === T);
    }, e.typeOf = E;
  })();
...
var Ze = Ue(null), Je = function(t) {
  var e = t.children, r = t.baseUrl, n = r === void 0 ? "http://rag-api.insytful.com/api/v1" : r, o = t.config, i = t.recaptchaSiteKey, a = f.createElement(Ze.Provider, { value: { config: o, baseUrl: n, recaptchaSiteKey: i } }, e);
  return i ? f.createElement(pt, { reCaptchaKey: i, scriptProps: { async: !0, defer: !0, appendTo: "head" } }, a) : a;
}, kt = function() {
  var t = Ye(Ze);
...
var Nt = function(t, e, r) {
  var n = H([]), o = n[0], i = n[1], a = H(!1), u = a[0], p = a[1], h = H(null), d = h[0], b = h[1], I = oe(function(N, R) {
    return Et(void 0, void 0, void 0, function() {
      var P, w, T, F, $, A, E, j, K, U, M, W, q, z, S, s, l, m, v, g, k, y;
      return St(this, function(c) {
        switch (c.label) {
          ...
          case 5:
            ...
            }), p(!0), b(null), c.label = 6;
          case 6:
            return c.trys.push([6, 17, , 18]), T = new URLSearchParams({ question: N, config: t, history: String(!0), stream: String(!0) }), R && R?.length >= 1 && T.set("sections", R.join(",")), F = T.toString(), $ = new Headers({ Accept: "text/event-stream" }), P && $.append("X-Recaptcha-Token", P), (A = localStorage.getItem("rag-session-id")) && $.append("X-Session-Id", A), [4, fetch("".concat(e, "/query-collection?").concat(F), { method: "GET", headers: $ })];
          case 7:
          ...
          case 9:
            return g = c.sent(), j = (y = g?.message) !== null && y !== void 0 ? y : j, [3, 12];
          case 10:
            return c.sent(), [4, E.text()];
          case 11:
            return (K = c.sent()) && (j = K), [3, 12];
          case 12:
            throw new Error(j);
          case 13:
            ...
            U = E.body.getReader(), M = new TextDecoder("utf-8"), W = "", q = "", i(function(x) {
              return re(re([], x, !0), [{ role: "assistant", content: "" }], !1);
            }), c.label = 14;
          case 14:
            return [4, U.read()];
          case 15:
            if (z = c.sent(), S = z.value, z.done) return [3, 16];
            for (W += M.decode(S, { stream: !0 }), s = W.split(`

`), W = s.pop() || "", l = 0, m = s; l < m.length; l++) {
              if ((v = m[l]).startsWith("event: done")) return p(!1), [2];
              if (v.startsWith("data:")) try {
                (g = JSON.parse(v.replace("data: ", ""))) != null && g.content && (q += g.content, i(function(x) {
                  var O = re([], x, !0);
                  return O[O.length - 1] = { role: "assistant", content: q }, O;
                }));
              } catch (x) {
                console.error("Failed to parse SSE chunk", x, v);
              }
            }
            return [3, 14];
          case 16:
            return p(!1), [3, 18];
          case 17:
            return k = c.sent(), console.error(k), b(k.message || "Something went wrong"), p(!1), [3, 18];
          case 18:
            return [2];
        }
      });
  ...
  return { messages: o, loading: u, error: d, ask: I };
}, Qe = function() {
...
`);
  return /* @__PURE__ */ f.createElement(
    ...
    t && !n && /* @__PURE__ */ f.createElement("div", { className: "insytful-search-message-logo flex-shrink-0 hidden md:block" }, t),
...
function Pt({
  ...
  const a = Y(null), [u, p] = H(!1), [h, d] = H(!1), b = Y(!1);
  V(() => {
    const w = a.current;
    if (!w) return;
    const T = () => p(w.scrollHeight > w.clientHeight);
    return T(), window.addEventListener("resize", T), () => window.removeEventListener("resize", T);
  }, [t]), V(() => {
    const w = a.current;
    if (!w) return;
    const T = 40, F = () => {
      const $ = w.scrollTop + w.clientHeight >= w.scrollHeight - T;
      d($), !e && $ && (b.current = !0);
    };
    return w.addEventListener("scroll", F), F(), () => w.removeEventListener("scroll", F);
  }, [t, e]);
  const I = u && !h, N = u && (e || !b.current) && !h, [R, P] = H(!1);
  return V(() => {
    if (!t || t.length === 0) {
      P(!1);
      return;
    }
    const w = t[t.length - 1], T = w?.role === "user", F = e && (!w || w.role === "user");
    P(T && F);
  }, [t, e]), V(() => {
    if (R) {
      const w = a.current;
  ...
  }, [R]), !t || t.length === 0 ? null : /* @__PURE__ */ f.createElement("div", { className: "flex-1 min-h-0 relative w-full max-w-full" }, /* @__PURE__ */ f.createElement(
    "div",
    {
      ref: a,
      className: `overflow-y-auto insytful-search-messages-container-scroll h-full w-full ${I ? "[mask-image:linear-gradient(to_bottom,black_0%,black_85%,transparent_100%)] [-webkit-mask-image:linear-gradient(to_bottom,black_0%,black_85%,transparent_100%)]" : ""}`
    },
    /* @__PURE__ */ f.createElement("div", { className: "insytful-search-messages-outer w-full max-w-[784px] mx-auto" }, /* @__PURE__ */ f.createElement("ul", { className: "insytful-search-messages-inner flex flex-col gap-[32px] max-w-full w-full p-0 m-0 list-none" }, t.map((w, T) => /* @__PURE__ */ f.createElement(
      Tt,
      {
        key: `${T}-${$e(w.content)}`,
        renderContent: o,
    ...
    )), R && /* @__PURE__ */ f.createElement(Ct, { logo: r }), !e && !n && /* @__PURE__ */ f.createElement(Rt, { onSwitchClassic: i })))
  ), N && /* @__PURE__ */ f.createElement("div", { className: "w-full max-w-[784px] mx-auto absolute left-1/2 -translate-x-1/2 bottom-0 flex flex-col justify-center items-center" }, /* @__PURE__ */ f.createElement(
    "div",
    {
...
function It({
  ...
  return /* @__PURE__ */ f.createElement(
    ...
    !e && /* @__PURE__ */ f.createElement("div", { className: "insytful-search-message-input-bg absolute inset-0 h-full w-full max-w-[784px] rounded-[16px] group-focus-within:opacity-60" }, /* @__PURE__ */ f.createElement(
      "div",
      {
        className: `pointer-events-none absolute inset-[-2px] rounded-[16px] opacity-30 blur-[7px] transition-opacity z-0 ${t ? "" : "bg-gradient-to-br from-[#35d2c5] via-[#35d2c5] to-[#1d70b8]"}`,
        "aria-hidden": "true"
      }
    )),
    /* @__PURE__ */ f.createElement(
...
const et = ct(
  function({
    ...
    const { left: A = 0, right: E = 0 } = a || {}, [j, K] = H(0), U = 200, [M, W] = H(h), [q, z] = H(!0), S = Y(null);
    return V(() => {
      if (M === h) return;
      z(!1);
      const s = setTimeout(() => {
      ...
      const s = () => {
        const v = document.querySelectorAll("[data-insytful-modal-offset]");
        let g = 0;
        v.forEach((k) => g += k.offsetHeight), K(g);
      };
      s();
      const l = document.querySelectorAll("[data-insytful-modal-offset]"), m = new ResizeObserver(() => s());
      return l.forEach((v) => m.observe(v)), () => m.disconnect();
      ...
      /* @__PURE__ */ f.createElement(
        ...
        (() => {
          const s = M ? o?.title ?? "" : e, l = M ? o?.text ?? "" : r, m = N.length === 0 || M && N.length >= 1, v = m && !!s;
          return /* @__PURE__ */ f.createElement("div", { "aria-live": "polite" }, !v && /* @__PURE__ */ f.createElement("h1", { id: "insytful-search-heading", className: "sr-only" }, M ? "Search" : e || "AI Search"), m && /* @__PURE__ */ f.createElement("div", { className: "insytful-search-empty-state-outer flex flex-col md:mt-auto items-stretch gap-[24px] md:items-center md:gap-[32px]" }, /* @__PURE__ */ f.createElement(
            Mt,
            {
              title: s,
              text: l
        ...
        ), P && /* @__PURE__ */ f.createElement("div", { className: "insytful-search-error-callout-outer flex items-center justify-start max-w-[740px] w-full mx-auto" }, /* @__PURE__ */ f.createElement(
          Ft,
          {
            onSwitchClassic: I,
            message: P
        ...
        (N.length === 0 || M && N.length >= 1) && /* @__PURE__ */ f.createElement("div", { className: "insytful-search-suggestions-container flex flex-col gap-[16px] md:gap-[40px]" }, /* @__PURE__ */ f.createElement(
          At,
          {
            onSend: w,
            suggestions: M ? o?.suggestions ?? [] : i
          }
        ), M && o?.renderSwitch ? o.renderSwitch(b) : !M && T ? T(b) : null),
        /* @__PURE__ */ f.createElement("div", { className: "insytful-search-disclaimer-outer flex flex-col gap-4 mt-auto pb-[24px]" }, n && !M && /* @__PURE__ */ f.createElement("div", { className: "insytful-search-disclaimer-inner text-sm leading-6 font-normal text-center text-[var(--lib-color-text-secondary)]" }, n))
      )
    );
  }
);
...
var tt = ["input:not([inert]):not([inert] *)", "select:not([inert]):not([inert] *)", "textarea:not([inert]):not([inert] *)", "a[href]:not([inert]):not([inert] *)", "button:not([inert]):not([inert] *)", "[tabindex]:not(slot):not([inert]):not([inert] *)", "audio[controls]:not([inert]):not([inert] *)", "video[controls]:not([inert]):not([inert] *)", '[contenteditable]:not([contenteditable="false"]):not([inert]):not([inert] *)', "details>summary:first-of-type:not([inert]):not([inert] *)", "details:not([inert]):not([inert] *)"], ge = /* @__PURE__ */ tt.join(","), rt = typeof Element > "u", ee = rt ? function() {
  ...
  for (var o = [], i = Array.from(e); i.length; ) {
    ...
    if (!we(a, !1))
      if (a.tagName === "SLOT") {
        var u = a.assignedElements(), p = u.length ? u : a.children, h = xe(p, !0, n);
        ...
        typeof n.getShadowRoot == "function" && n.getShadowRoot(a), I = !we(b, !1) && (!n.shadowRootFilter || n.shadowRootFilter(a));
        if (b && I) {
  ...
  return e.tabIndex < 0 && (/^(AUDIO|VIDEO|DETAILS)$/.test(e.tagName) || Ot(e)) && !at(e) ? 0 : e.tabIndex;
}, $t = function(e, r) {
  var n = Q(e);
  ...
  if (n && n !== e) {
    var a, u, p;
    for (i = !!((a = o) !== null && a !== void 0 && (u = a.ownerDocument) !== null && u !== void 0 && u.contains(o) || e != null && (p = e.ownerDocument) !== null && p !== void 0 && p.contains(e)); !i && o; ) {
      var h, d, b;
  ...
  return e.forEach(function(o, i) {
    var a = !!o.scopeParent, u = a ? o.scopeParent : o, p = $t(u, a), h = a ? it(o.candidates) : u;
    p === 0 ? a ? r.push.apply(r, h) : r.push(u) : n.push({
      documentOrder: i,
      tabIndex: p,
      item: o,
      isScope: a,
  ...
  return r.getShadowRoot ? n = xe([e], r.includeContainer, {
    ...
    shadowRootFilter: Vt
  }) : n = nt(e, r.includeContainer, Fe.bind(null, r)), it(n);
}, Wt = function(e, r) {
  r = r || {};
  var n;
  return r.getShadowRoot ? n = xe([e], r.includeContainer, {
  ...
  if (r = r || {}, !e)
    throw new Error("No node provided");
  return ee.call(e, ge) === !1 ? !1 : Fe(r, e);
...
var X = {
  ...
  var n = r?.document || document, o = r?.trapStack || sr, i = Ge({
    ...
    return a.containerGroups.findIndex(function(v) {
      var g = v.container, k = v.tabbableNodes;
      return g.contains(s) || m?.includes(g) || k.find(function(y) {
        return y === s;
      });
    });
  }, d = function(s) {
    var l = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, m = l.hasFallback, v = m === void 0 ? !1 : m, g = l.params, k = g === void 0 ? [] : g, y = i[s];
    if (typeof y == "function" && (y = y.apply(void 0, er(k))), y === !0 && (y = void 0), !y) {
      if (y === void 0 || y === !1)
        return y;
    ...
    if (a.containerGroups = a.containers.map(function(s) {
      var l = Ut(s, i.tabbableOptions), m = Wt(s, i.tabbableOptions), v = l.length > 0 ? l[0] : void 0, g = l.length > 0 ? l[l.length - 1] : void 0, k = m.find(function(x) {
        return te(x);
      }), y = m.slice().reverse().find(function(x) {
        return te(x);
      }), c = !!l.find(function(x) {
        return Q(x) > 0;
      });
      return {
        ...
        nextTabbableNode: function(O) {
          var L = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !0, G = l.indexOf(O);
          return G < 0 ? L ? m.slice(m.indexOf(O) + 1).find(function(J) {
            return te(J);
          }) : m.slice(0, m.indexOf(O)).reverse().find(function(J) {
            return te(J);
          }) : l[G + (L ? 1 : -1)];
        }
      };
    ...
    var l = s.target, m = s.event, v = s.isBackward, g = v === void 0 ? !1 : v;
    l = l || se(m), I();
    var k = null;
    if (a.tabbableGroups.length > 0) {
      var y = h(l, m), c = y >= 0 ? a.containerGroups[y] : void 0;
      if (y < 0)
        g ? k = a.tabbableGroups[a.tabbableGroups.length - 1].lastTabbableNode : k = a.tabbableGroups[0].firstTabbableNode;
      else if (g) {
        var x = a.tabbableGroups.findIndex(function(Ee) {
          var Se = Ee.firstTabbableNode;
          return l === Se;
        });
        if (x < 0 && (c.container === l || Ne(l, i.tabbableOptions) && !te(l, i.tabbableOptions) && !c.nextTabbableNode(l, !1)) && (x = y), x >= 0) {
          var O = x === 0 ? a.tabbableGroups.length - 1 : x - 1, L = a.tabbableGroups[O];
          k = Q(l) >= 0 ? L.lastTabbableNode : L.lastDomTabbableNode;
        } else ie(m) || (k = c.nextTabbableNode(l, !1));
      } else {
        var G = a.tabbableGroups.findIndex(function(Ee) {
          var Se = Ee.lastTabbableNode;
          return l === Se;
        });
        if (G < 0 && (c.container === l || Ne(l, i.tabbableOptions) && !te(l, i.tabbableOptions) && !c.nextTabbableNode(l)) && (G = y), G >= 0) {
          var J = G === a.tabbableGroups.length - 1 ? 0 : G + 1, Z = a.tabbableGroups[J];
          k = Q(l) >= 0 ? Z.firstTabbableNode : Z.firstDomTabbableNode;
        } else ie(m) || (k = c.nextTabbableNode(l));
      }
    } else
      k = d("fallbackFocus");
    return k;
    ...
    if (m || l instanceof Document)
      ...
      if (a.mostRecentlyFocusedNode)
        if (Q(a.mostRecentlyFocusedNode) > 0) {
          var k = h(a.mostRecentlyFocusedNode), y = a.containerGroups[k].tabbableNodes;
          if (y.length > 0) {
            var c = y.findIndex(function(x) {
              return x === a.mostRecentlyFocusedNode;
            });
            c >= 0 && (i.isKeyForward(a.recentNavEvent) ? c + 1 < y.length && (v = y[c + 1], g = !1) : c - 1 >= 0 && (v = y[c - 1], g = !1));
          }
        } else
          a.containerGroups.some(function(x) {
            return x.tabbableNodes.some(function(O) {
              return Q(O) > 0;
            });
          }) || (g = !1);
      else
      ...
      })), R(v || a.mostRecentlyFocusedNode || b());
    }
    ...
    (i.isKeyForward(s) || i.isKeyBackward(s)) && $(s, i.isKeyBackward(s));
  }, E = function(s) {
    ...
    if (a.active)
      return X.activateTrap(o, u), a.delayInitialFocusTimer = i.delayInitialFocus ? Ve(function() {
        R(b());
      }) : R(b()), n.addEventListener("focusin", F, !0), n.addEventListener("mousedown", T, {
        capture: !0,
        passive: !1
    ...
    var l = /* @__PURE__ */ new Set(), m = /* @__PURE__ */ new Set(), v = Ke(s), g;
    try {
      for (v.s(); !(g = v.n()).done; ) {
        var k = g.value;
        l.add(k);
        for (var y = typeof ShadowRoot < "u" && k.getRootNode() instanceof ShadowRoot, c = k; c; ) {
          l.add(c);
          var x = c.parentElement, O = [];
          x ? O = x.children : !x && y && (O = c.getRootNode().children, x = c.getRootNode().host, y = typeof ShadowRoot < "u" && x.getRootNode() instanceof ShadowRoot);
          var L = Ke(O), G;
          try {
            for (L.s(); !(G = L.n()).done; ) {
              var J = G.value;
    ...
    if (a.active)
      return n.removeEventListener("focusin", F, !0), n.removeEventListener("mousedown", T, !0), n.removeEventListener("touchstart", T, !0), n.removeEventListener("click", j, !0), n.removeEventListener("keydown", A, !0), n.removeEventListener("keydown", E), u;
  }, W = function(s) {
    var l = s.some(function(m) {
      var v = Array.from(m.removedNodes);
      return v.some(function(g) {
        return g === a.mostRecentlyFocusedNode;
      });
    });
    l && R(b());
  }, q = typeof window < "u" && "MutationObserver" in window ? new MutationObserver(W) : void 0, z = function() {
  ...
  return u = {
    ...
    activate: function(s) {
      if (a.active)
        return this;
      var l = p(s, "onActivate"), m = p(s, "onPostActivate"), v = p(s, "checkCanFocusTrap"), g = X.getActiveTrap(o), k = !1;
      if (g && !g.paused) {
        var y;
        (y = g._setSubtreeIsolation) === null || y === void 0 || y.call(g, !1), k = !0;
      }
      try {
        v || I(), a.active = !0, a.paused = !1, a.nodeFocusedBeforeActivation = N(n), l?.();
        var c = function() {
          v && I(), K(), z(), i.isolateSubtrees && u._setSubtreeIsolation(!0), m?.();
        };
        if (v)
          return v(a.containers.concat()).then(c, c), this;
        c();
      } catch (O) {
        if (g === X.getActiveTrap(o) && k) {
          var x;
          (x = g._setSubtreeIsolation) === null || x === void 0 || x.call(g, !0);
        }
        throw O;
      }
      return this;
    ...
    deactivate: function(s) {
      ...
      clearTimeout(a.delayInitialFocusTimer), a.delayInitialFocusTimer = void 0, a.paused || u._setSubtreeIsolation(!1), a.alreadySilent.clear(), M(), a.active = !1, a.paused = !1, z(), X.deactivateTrap(o, u);
      var m = p(l, "onDeactivate"), v = p(l, "onPostDeactivate"), g = p(l, "checkCanReturnFocus"), k = p(l, "returnFocus", "returnFocusOnDeactivate");
      m?.();
      var y = function() {
        Ve(function() {
          k && R(P(a.nodeFocusedBeforeActivation)), v?.();
        });
      };
      return k && g ? (g(P(a.nodeFocusedBeforeActivation)).then(y, y), this) : (y(), this);
    },
    pause: function(s) {
    ...
    updateContainerElements: function(s) {
      ...
      }), i.isolateSubtrees && U(a.containers), a.active && (I(), i.isolateSubtrees && !a.paused && u._setSubtreeIsolation(!0)), z(), this;
    }
    ...
    _setPausedState: {
      value: function(s, l) {
        if (a.paused === s)
          return this;
        if (a.paused = s, s) {
          var m = p(l, "onPause"), v = p(l, "onPostPause");
          m?.(), M(), z(), u._setSubtreeIsolation(!1), v?.();
        } else {
          var g = p(l, "onUnpause"), k = p(l, "onPostUnpause");
          g?.(), u._setSubtreeIsolation(!0), I(), K(), z(), k?.();
        }
        return this;
      }
    },
...
`;
            u.enqueue(p.encode(d)), await new Promise((b) => setTimeout(b, 30));
          }
          u.enqueue(p.encode(`event: done
data: {}
...
function pr(t) {
  ...
  fr(I, N?.baseUrl ?? "");
  const { messages: R, loading: P, error: w, ask: T } = Qe(), F = oe((M) => {
    b?.(M);
  }, [b]), [$, A] = H(!1), E = oe(() => A((M) => !M), []), j = oe(() => {
    A(!0);
  }, []), { elModalRef: K } = ur(F, d), U = cr({ isClassic: $, ask: T, classic: o, onClose: () => F(!1) });
  return /* @__PURE__ */ f.createElement(
    et,
    {
      title: e,
...
class vr extends br {
  ...
  createRootFn;
  instanceId;
  handleOpenChange = (e) => this.onToggle(e);
  ...
  constructor() {
    ...
    r.className = "insytful-root", this.elPortalShadowDOM.append(
      ...
      this.elCustomStyle,
      r
    ), this.elMount = r, _.props.theme && (this.elCustomStyle.textContent = _.props.theme), ae = this;
  }
  connectedCallback() {
    if (typeof window > "u" || typeof document > "u") return;
    document.getElementById("insytful-ai-modal-portal") || document.body.appendChild(this.elPortal), Object.keys(_.props).length > 0 && this.render();
  }
  ...
  cleanup() {
    typeof window > "u" || (this.isReact18 && this.root ? (this.root.unmount(), this.root = void 0) : !this.isReact18 && this.elMount && De.unmountComponentAtNode(this.elMount), this.elPortal && this.elPortal.parentNode && document.body.removeChild(this.elPortal), _.isOpen = !1, document.body.style.overflow = this.previousBodyOverflow, document.body.style.paddingRight = this.previousBodyPaddingRight);
  }
  ...
  onToggle(e) {
    ...
    if (r !== _.isOpen) {
      if (_.isOpen = r, r) {
        this.previousBodyOverflow = document.body.style.overflow, this.previousBodyPaddingRight = document.body.style.paddingRight;
        ...
        document.body.style.overflow = this.previousBodyOverflow, document.body.style.paddingRight = this.previousBodyPaddingRight;
  ...
  render() {
    ...
    const { options: r, ...n } = _.props;
    if (!r?.config && !n.isDevMode) {
      console.warn(`[Insytful #${this.instanceId}] ⚠️ Render skipped - options.config missing and not in dev mode`), console.warn(`[Insytful #${this.instanceId}] Current global state:`, _);
      return;
    }
    const o = /* @__PURE__ */ f.createElement(
      pr,
      {
        options: r || { config: "" },
        title: n.title ?? "",
    ...
    this.isReact18 ? (!this.root && this.createRootFn && (this.root = this.createRootFn(this.elMount)), this.root?.render(i)) : De.render(i, this.elMount);
  }
}
function wr() {
  const t = lt();
