...
`);
  return /* @__PURE__ */ p.createElement("li", { className: `insytful-search-message flex items-start gap-[24px] w-full max-w-full ${n ? "flex-row-reverse" : "flex-row"}` }, t && !n && /* @__PURE__ */ p.createElement("div", { className: "insytful-search-message-logo flex-shrink-0 hidden md:block" }, t), /* @__PURE__ */ p.createElement(
    "div",
    {
...
function Rt({
  ...
  return !t || t.length === 0 ? null : /* @__PURE__ */ p.createElement("div", { className: "insytful-search-messages-container-scroll overflow-y-auto min-h-0 flex-1 " }, /* @__PURE__ */ p.createElement(
    ...
    )), e && t.length <= 1 && /* @__PURE__ */ p.createElement(Tt, { logo: r }), !e && /* @__PURE__ */ p.createElement(Ct, { onSwitchClassic: o }))
  ));
}
function Pt({
  hasMessages: t,
